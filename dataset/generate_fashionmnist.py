...
def generate_dataset(cfg):
    ...
    trainset = torchvision.datasets.FashionMNIST(root="~/Dataset/",
                                          train=True, download=True, transform=transform)
    testset = torchvision.datasets.FashionMNIST(root="~/Dataset/",
...
if __name__ == "__main__":
    ...
    assert config['dir_path'].lower() == 'fashionmnist', 'Dataset name does not match saving dir_path (dataset/config.yaml) !'
