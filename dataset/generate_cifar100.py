...
def generate_dataset(cfg):
    ...
    trainset = torchvision.datasets.CIFAR100(
        root="/data/mayiming/Dataset/CIFAR100", train=True, download=True, transform=transform
    )
    testset = torchvision.datasets.CIFAR100(
        root="/data/mayiming/Dataset/CIFAR100", train=False, download=True, transform=transform
    )
...
if __name__ == "__main__":
    ...
    assert (
        config["dir_path"].lower() == "cifar100"
