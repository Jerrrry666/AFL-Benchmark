...
from utils.dataset_utils import check, dataset_to_numpy, save_file, separate_data, split_data
...
if __name__ == "__main__":
    ...
    assert config[
               'dir_path'].lower() == 'cifar10', 'Dataset name does not match saving dir_path (dataset/config.yaml) !'
