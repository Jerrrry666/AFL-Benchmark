...
def generate_dataset(cfg):
    ...
    trainset = torchvision.datasets.CIFAR10(
        root="/data/mayiming/Dataset/CIFAR10", train=True, download=True, transform=transform
    )
    testset = torchvision.datasets.CIFAR10(
        root="/data/mayiming/Dataset/CIFAR10", train=False, download=True, transform=transform
    )
